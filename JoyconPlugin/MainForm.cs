...
namespace BetterJoyForCemu {
    public partial class MainForm : Form {
        ...
        private void ShowFromTray() {
            ...
            this.Icon = JoyconPlugin.Properties.Resources.betterjoyforcemu_icon;
            ...
            if (button.Tag.GetType() == typeof(Joycon)) {
                ...
                if (v.other == null && !v.isPro) { // needs connecting to other joycon (so messy omg)
                        ...
                        foreach (Joycon jc in Program.mgr.j) {
                            if (!jc.isPro && jc.isLeft != v.isLeft && jc != v && jc.other == null) {
                                ...
                                foreach (Button b in con)
                                    if (b.Tag == jc)
                                        b.BackgroundImage = jc.isLeft ? JoyconPlugin.Properties.Resources.jc_left : JoyconPlugin.Properties.Resources.jc_right;
                    ...
                    if (succ)
                        foreach (Button b in con)
                            if (b.Tag == v)
                                b.BackgroundImage = v.isLeft ? JoyconPlugin.Properties.Resources.jc_left : JoyconPlugin.Properties.Resources.jc_right;
                } else if (v.other != null && !v.isPro) { 

                    button.BackgroundImage = v.isLeft ? JoyconPlugin.Properties.Resources.jc_left_s : JoyconPlugin.Properties.Resources.jc_right_s;

                    foreach (Button b in con)
                        if (b.Tag == v.other)
                            b.BackgroundImage = v.other.isLeft ? JoyconPlugin.Properties.Resources.jc_left_s : JoyconPlugin.Properties.Resources.jc_right_s;
